            ...
            sections: [
                ...
                },
                {
                    ...
                    controls: [
                        ...
                        { type: 'subheader', label: 'Edge Bevel' },
                        { type: 'slider', id: 'glass-edge-width', label: 'Edge Width', param: 'glassParams.edgeWidth', min: 10, max: 150, step: 5, decimals: 0 },
                        { type: 'slider', id: 'glass-bevel-depth', label: 'Bevel Depth', param: 'glassParams.bevelDepth', min: 0, max: 1, step: 0.05, decimals: 2 },
                        { type: 'subheader', label: 'Lens Refraction' },
                        { type: 'slider', id: 'glass-ior', label: 'IOR', param: 'glassParams.ior', min: 1.0, max: 2.5, step: 0.05, decimals: 2 },
                        { type: 'slider', id: 'glass-dispersion', label: 'Dispersion', param: 'glassParams.dispersion', min: 0, max: 5, step: 0.1, decimals: 1 },
                        { type: 'slider', id: 'glass-thickness', label: 'Thickness (cm)', param: 'glassParams.thickness', min: 0, max: 10, step: 0.5, decimals: 1 },
                        ...
                        { type: 'subheader', label: 'Surface Dust' },
                        { type: 'slider', id: 'glass-dust-density', label: 'Density', param: 'glassParams.dustDensity', min: 0, max: 1, step: 0.05, decimals: 2 },
                        { type: 'slider', id: 'glass-dust-size', label: 'Size', param: 'glassParams.dustSize', min: 0.2, max: 3, step: 0.1, decimals: 1 },
                        { type: 'slider', id: 'glass-dust-brightness', label: 'Brightness', param: 'glassParams.dustBrightness', min: 0, max: 0.2, step: 0.005, decimals: 3 },
